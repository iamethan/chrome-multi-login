...
Isolate login sessions per tab — log into the same website with multiple accounts simultaneously, without interference. An Chrome browser and Edge browser extension similar to SessionBox.
